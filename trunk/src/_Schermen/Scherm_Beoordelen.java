...
public class Scherm_Beoordelen extends JFrame implements ActionListener {
	...
	public Scherm_Beoordelen(ProgrammaController programmaC, Wedstrijd wedstrijd)
	{
